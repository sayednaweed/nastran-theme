...
export const useTheme = () => { var _a; return (_a = useContext(ThemeContext)) !== null && _a !== void 0 ? _a : defaultContext; };
...
const Theme = ({ forcedTheme, disableTransitionOnChange = false, enableSystem = true, enableColorScheme = true, storageKey = 'theme', themes = defaultThemes, defaultTheme = enableSystem ? 'system' : 'light', attribute = 'data-theme', value, children, nonce }) => {
    ...
    return (React.createElement(ThemeContext.Provider, { value: providerValue },
        React.createElement(ThemeScript, { forcedTheme,
...
const ThemeScript = memo(({ forcedTheme, storageKey, attribute, enableSystem, enableColorScheme, defaultTheme, value, attrs, nonce }) => {
    ...
    return React.createElement("script", { nonce: nonce, dangerouslySetInnerHTML: { __html: scriptSrc } });
}, 
